  ...
  return (
    <div className="pb-14 mt-20">
      ...
      <div className="flex md:flex-nowrap flex-wrap md:px-16 px-5 py-5">
        ...
        <div className="px-5 justify-end h-full lg:w-1/3 md:w-6/12 w-full">
        ...
        <div className="px-5 h-full lg:w-2/5 md:w-6/12 w-full">
          <div
            ...
            className="relative cursor-pointer bg-love-story bg-cover bg-center bg-no-repeat bg-fixed h-[500px]"
          >
        ...
        <div className="px-5 justify-start h-full md:w-1/3 w-full">
          <div className="h-full">
            <div
              ...
              className="relative cursor-pointer bg-power-shooter bg-cover bg-center bg-no-repeat bg-fixed h-[300px]"
            >
