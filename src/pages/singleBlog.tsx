    ...
    >
      ...
      <section className="px-32 mt-20">
        <div className="justify-center flex">
          <img
            src={require("../assets/img/big-rectangle.png")}
            className="w-full"
            alt=""
          />
        </div>
        ...
        <section className="justify-center flex">
          <div className="content w-full">
            ...
            <p className="font-[500] text-lg mt-3">
              It was a blast at the wedding ceremony of the year as we can say
              at Deesignal Media, as we filmed and captured beautiful moments
              from the attendees of “Tayo&Ife2023” Happy Matrimony.
            </p>
            ...
            <p className="text-gray-600 mt-4 font-light tracking-wide">
              ...
              massa. Cum sociis natnatibus et magnis irturienntes, nascetur
              sociis natnatibus et magnisrienntes, nascetur mmodo ligulaet
              dolor. Aenean maa. Cum... "Sed ut perspiciatis unde omnis iste
